...
Armory and Netflix engineers have built a plugin framework that helps you extend Spinnaker without having to add custom stages. The new plugin system allows us to integrate services with Spinnaker outside of runtime, with clearly defined extension points to work from. The new [Plugin Creators Guide](/guides/developer/plugin-creators/overview/) walks us through creating and loading a simple plugin. Use it as a starting point to build your own!
